...
section Power_BI_Admin_API_Connector;
...
client_id = "e309e45d-5bd9-4fc3-a3a5-9ad55efa0393"; //Text.FromBinary(Extension.Contents("client_id"));
client_secret = "@-_+!/{QwhNt=8}+=pnn*[P;?_^;O/.:ax%|s!-?|y*&&}Fl)+T;$|*;%:"; //Text.FromBinary(Extension.Contents("client_secret"));
...
scopes = {
    "openid","Dataset.Read.All"
};

[DataSource.Kind="Power_BI_Admin_API_Connector", Publish="Power_BI_Admin_API_Connector.Publish"]
shared Power_BI_Admin_API_Connector.Contents = () =>
    let
...
Power_BI_Admin_API_Connector = [
    TestConnection = (dataSourcePath) => { "Power_BI_Admin_API_Connector.Contents" },
    Authentication = [
        OAuth = [
...
Power_BI_Admin_API_Connector.Publish = [
    Beta = true,
    Category = "Other",
    ButtonText = { "Power_BI_Admin_API_Connector.Contents", "Connect to Power BI API" },
    LearnMoreUrl = "https://powerbi.microsoft.com/",
    SourceImage = Power_BI_Admin_API_Connector.Icons,
    SourceTypeImage = Power_BI_Admin_API_Connector.Icons
];

Power_BI_Admin_API_Connector.Icons = [
    Icon16 = { Extension.Contents("Power_BI_Admin_API_Connector16.png"), Extension.Contents("Power_BI_Admin_API_Connector20.png"), Extension.Contents("Power_BI_Admin_API_Connector24.png"), Extension.Contents("Power_BI_Admin_API_Connector32.png") },
    Icon32 = { Extension.Contents("Power_BI_Admin_API_Connector32.png"), Extension.Contents("Power_BI_Admin_API_Connector40.png"), Extension.Contents("Power_BI_Admin_API_Connector48.png"), Extension.Contents("Power_BI_Admin_API_Connector64.png") }
];
